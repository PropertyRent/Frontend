        ...
        <div className="md:col-span-7 bg-transparent">
          <div className="px-2 md:px-0">
            ...
            <div className="mt-5 grid grid-cols-1 sm:grid-cols-2 gap-3">
              ...
              <button onClick={() => handle(onApply, "/properties")} aria-label="Submit application" className="flex items-center gap-3 px-4 py-3 rounded-lg font-medium bg-[var(--color-secondary)] text-white shadow-md hover:bg-[var(--color-darker)] transition-colors focus:outline-none focus:ring-2 focus:ring-[var(--color-secondary)]">
              ...
              <button onClick={() => handle(onTour, "/properties")} aria-label="Schedule tour" className="flex items-center gap-3 px-4 py-3 rounded-lg font-medium border border-[var(--color-secondary)] text-[var(--color-secondary)] bg-white hover:bg-[var(--color-secondary)] hover:text-white transition-colors focus:outline-none focus:ring-2 focus:ring-[var(--color-secondary)]">
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden>
              ...
              <button onClick={() => handle(onAvailability, "/properties")} aria-label="View availability" className="flex items-center gap-3 px-4 py-3 rounded-lg font-medium bg-[var(--color-tan)] text-[var(--color-darkest)] hover:bg-[var(--color-light-brown)] transition-colors focus:outline-none">
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden>
