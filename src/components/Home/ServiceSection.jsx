    ...
    <section>
        <div className="container mx-auto py-12">
            ...
            <div className='flex justify-center gap-2 mt-4'>
                <Link to="/services/maintenance" className="bg-white text-[var(--color-secondary)] border-2 border-[var(--color-secondary)] hover:border-[var(--color-secondary)] rounded-full hover:bg-[var(--color-secondary)] hover:text-white text-md md:text-xl py-2 px-4 cursor-pointer transition-colors">Maintenance Services</Link>
            </div>
        </div>
    </section>
  )
