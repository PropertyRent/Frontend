    ...
    <section>
        <div className="container mx-auto py-12">
            ...
            <div className='flex justify-center gap-2 mt-4'>
                <button className="bg-[var(--color-bg)] text-[var(--color-darkest)] border-2 border-[var(--color-darkest)] hover:border-[var(--color-dark)] rounded-full hover:bg-[var(--color-dark)] hover:text-white text-md md:text-xl py-2 px-4 cursor-pointer">Management Services</button>
                <button className="bg-[var(--color-bg)] text-[var(--color-darkest)] border-2 border-[var(--color-darkest)] hover:border-[var(--color-dark)] rounded-full hover:bg-[var(--color-dark)] hover:text-white text-md md:text-xl py-2 px-4 ml-4 cursor-pointer">Other Services</button>
            </div>
        </div>
    </section>
  )
